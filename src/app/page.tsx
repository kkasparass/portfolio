...
export default function Home() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-zinc-50 font-sans dark:bg-black">
      <main className="flex min-h-screen w-full max-w-3xl flex-col items-center gap-16 justify-between py-32 px-16 bg-white dark:bg-black sm:items-start">
        <IntroductionSection />
        <SkillsSection />
        <section className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              >
                <h4 className="text-l font-semibold">Favur</h4>
              </a>
              <p>
              ...
              <p>
                I also led a huge redesign/FE restructuring initiative to revamp
                the project&#x2019;s component base and set up testing for the
                project.
              </p>
              <strong>Key skills:</strong>
              <p>
                React, Typescript, GraphQL, Apollo Client, Elixir, PostgreSQL,
                Ionic, Capacitor, MateiralUI
              </p>
            </div>

            <div className="flex flex-col gap-2">
              <a target="_blank" href="https://www.sabag.ch/de/innenausbau">
                <h4 className="text-l font-semibold">SABAG</h4>
              </a>
              <p>
              ...
              <strong>Key skills:</strong>
              <p>
                React, Typescript, GraphQL, Apollo Client, Tanstack Query,
                RestAPI, PHP, PostgreSQL
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <p>
              ...
              <br />
              The application mostly was a portal to upload information about
              rental units and managing tenant applications and communications
              along each step.
              <br />
            ...
            <strong>Key skills:</strong>
            <p>React, Typescript, GraphQL, Apollo Client, React Native</p>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <strong>Key skills:</strong>
            <p>C, C++, Java, Javascript, UX best practices, a bunch of math</p>
          </div>
        </section>
        <section>
          <h1>Cntact info</h1>
